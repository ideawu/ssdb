	...
	def request(this, cmd, params=None):
		...
		while True:
			if False or ((cmd) == 'set') or ((cmd) == 'zset') or ((cmd) == 'hset') or ((cmd) == 'del') or ((cmd) == 'zdel') or ((cmd) == 'hdel') or ((cmd) == 'multi_set') or ((cmd) == 'multi_del'):
				...
				break
			if False or ((cmd) == 'incr') or ((cmd) == 'decr') or ((cmd) == 'zincr') or ((cmd) == 'zdecr') or ((cmd) == 'hincr') or ((cmd) == 'hdecr') or ((cmd) == 'get') or ((cmd) == 'zget') or ((cmd) == 'hget'):
				pass
				...
				if resp[0]=='ok':
					...
					return SSDB_Response(resp[0])
				break
			if False or ((cmd) == 'keys') or ((cmd) == 'zkeys') or ((cmd) == 'hkeys'):
				pass
				data = []
				...
				break
			if False or ((cmd) == 'scan') or ((cmd) == 'rscan') or ((cmd) == 'zscan') or ((cmd) == 'zrscan') or ((cmd) == 'hscan') or ((cmd) == 'hrscan'):
				pass
